                				...
                				<div class="widget-rounded-circle card">
                					<div class="card-body">
                						<div class="row">
                							...
                							<div class="col-6">
                								<div class="text-end">
                									<h3 class="text-dark mt-1"><span data-plugin="counterup">58</span>
                									</h3>
                				...
                				<div class="widget-rounded-circle card">
                					<div class="card-body">
                						<div class="row">
                							...
                							<div class="col-6">
                								<div class="text-end">
                									<h3 class="text-dark mt-1"><span data-plugin="counterup"></span>
                									</h3>
                				...
                				<div class="widget-rounded-circle card">
                					<div class="card-body">
                						<div class="row">
                							...
                							<div class="col-6">
                								<div class="text-end">
                									<h3 class="text-dark mt-1"><span data-plugin="counterup">82</span>
                									</h3>
