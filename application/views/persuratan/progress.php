                ...
                <article class="timeline-item timeline-item-left">
                    <div class="timeline-desk">
                        <div class="timeline-box">
                            ...
                            <h4 class="mt-0 font-16">08:00</h4>
                            <p class="mb-0">Surat berada di <strong>Ptsp</strong></p>
                        </div>
                    </div>
                </article>
                    ...
                    <div class="timeline-desk">
                        <div class="panel">
                            <div class="timeline-box">
                                <span class="arrow-alt"></span>
                                <span class="timeline-icon"><i class="mdi mdi-adjust"></i></span>
                                <h4 class="mt-0 font-16">08:40</h4>
                                <p class="mb-0">Surat telah kembali ke <strong>Persuratan</strong></p>
                            </div>
                        </div>
                    </div>
                </article>
